...
**1.** Напишете функция, която приема число и отпечатва неговата факторизация (произведението на други простите множители на оригиналното число)
</br>
**Пример:**
</br>
Вход:
...
2^3 * 3^2 * 13 * 23
```
**2.** Напишете функция, която приема число и отпечатва неговата факторизация (произведението на други простите множители на оригиналното число) в обратен ред
</br>
**Пример:**
</br>
Вход:
