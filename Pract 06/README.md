...
Напишете програма, която чете цяло число $`k \, (k \leq 100)`$, масив от $`k`$ елемента, който представлява множество, цяло число $`n \, (n \leq 100)`$ и релация като масив в същия вид като в предната (12-та) задача.
